<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('barber-shops.list')" :active="request()->routeIs('barber-shops.list')">
                        {{ __('Barberías') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
                            ...
                            <span class="px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full ms-2 dark:bg-green-900 dark:text-green-300">
                                <span title="{{ __('Créditos disponibles') }}">{{ __('Créditos: ') . Auth::user()->credit }}</span>
                            </span>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('barber-shops.list')" :active="request()->routeIs('barber-shops.list')">
                {{ __('Barberías') }}
            </x-responsive-nav-link>
